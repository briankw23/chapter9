using System;
using System.IO; // types for managing file system
...
namespace WorkingWIthFileSystems
{
    class Program
    {
        ...
        static void WorkWithDirectories()
        {
            ...
            var newFolder = Combine(GetFolderPath(SpecialFolder.Personal), "workspaces", "csharp", "chapter9", "New Folder");
        ...
        static void WorkWithFiles()
        {
            ...
            // starting in the user's folder
            var dir = Combine(GetFolderPath(SpecialFolder.Personal), "workspaces", "csharp", "chapter9", "Output Files");
            CreateDirectory(dir);
            ...
            ReadLine();
            // delete file File.Delete(textFile);
            WriteLine($"Does it exist? {File.Exists(textFile)}");
